...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        // Check if the user has a custom icon
        if ($row['icon_path'] != 'icon/default.png') {
            header("Location: loadingpage.php"); // Redirect to loading page if icon is set
        } else {
            header("Location: usernameprofile.php"); // Redirect to profile page if icon is not set
        }
        exit();
    } else {
